cd ../methods/ &&
cp ../pharma/$1/$2/train/bk.pl bk_copy_3.pl &&
python3 methods.py --bk-file bk_copy_1.pl --bias-file-popper ../zendo/$1/$2/train/bias_orig.pl --bias-file-aleph ../zendo/$1/$2/train/bias_aleph.pl --bias-file-new ../zendo/$1/$2/train/bias.pl --examples-file ../zendo/$1/$2/train/exs.pl --method BC-union-few --K 10 > ../zendo/$1/$2/bottom_clause.txt &&
cd ../pharma/ &&
